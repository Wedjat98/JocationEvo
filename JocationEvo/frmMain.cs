...
namespace LocationCleaned
{
    public partial class frmMain : Form
    {
        ...
        public frmMain()
        {
            ...
            InitializeComponent();
            ReadLocationFromDB();
            PrintMessage("MIT协议下的免费开源软件，请勿用作非法用途^_^");
            PrintMessage("第一开源作者：https://github.com/JonneyDong/JocationRelease");
            PrintMessage("第二开源作者：https://github.com/quxiaozha/JocationPlus");
        ...
        private void txtLocation_MouseWheel(object sender, MouseEventArgs e)
        {
